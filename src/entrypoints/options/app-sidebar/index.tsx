...
import readFrogLogo from "@/assets/icons/owlnest-icon.png"
import {
  InputGroup,
  InputGroupAddon,
  InputGroupInput,
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="group-data-[state=expanded]:px-5 group-data-[state=expanded]:pt-4 transition-all">
        <a href={browser.runtime.getURL("/onboarding.html")} className="flex items-center gap-2" target="_blank" rel="noopener noreferrer">
