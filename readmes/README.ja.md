...
[公式サイト](https://owlnest.app) · [チュートリアル](https://www.owlnest.app/docs) · [更新履歴][github-release-link] · [ブログ](https://www.owlnest.app/blog)
...
<div align="center">
  <img src="../assets/node-translation-demo.gif" width="38%" alt="OwlNest ポップアップ画面" />
  <img src="../assets/page-translation-demo.gif" width="60%" alt="OwlNest 翻訳画面" />
</div>

## 👋🏻 はじめに・コミュニティ

OwlNest のビジョンは、あらゆるレベルの言語学習者に、使いやすく、賢く、個人に合わせた学習体験を届けることです。AI の時代になり、それは現実的になりましたが、市場にはこの需要を満たす製品がまだ多くありません。そこで私たちは自分たちで作ることにしました。

ユーザーであっても開発者であっても、OwlNest はこのビジョンに向かうための重要なツールになります。現在も活発に開発中のため、問題を見つけた場合はぜひ[Issue][issues-link]で知らせてください。
...
OwlNest の機能で、毎日の Web 読書を没入型の言語学習体験に変えられます。
...
読んでいる内容の文脈を AI に理解させます。有効にすると、OwlNest はページタイトルと簡潔な Markdown 版の本文を抽出し、より正確で文脈に合った翻訳のために AI へ渡します。
...
1. OwlNest を友人や家族に紹介する。
2. [Issue][issues-link] やフィードバックを報告する。
3. コードを貢献する。

### コードで貢献

プロジェクト構成：[DeepWiki](https://deepwiki.com/DeepOrcaLab/OwlNest)

AI にプロジェクトを理解させる：[Dosu](https://app.dosu.dev/29569286-71ba-47dd-b038-c7ab1b9d0df7/documents)

詳しくは [Contribution Guide](https://owlnest.app/en/docs/code-contribution/contribution-guide) を確認してください。
...
<img src="../assets/tabbit.avif" alt="Tabbit" height="20" /> **Meituan Tabbit Browser Team**: クローズドソースの商用利用に対する無料ライセンス。対象は v1.21.3 以前（commit [`724863f`](https://github.com/DeepOrcaLab/OwlNest/commit/724863fdbc2d777766cada6c111235534ee03ca0)）です。付与日は 2026 年 3 月 3 日午前 9:00（バンクーバー時間、UTC-8）です。
