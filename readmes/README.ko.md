...
[공식 웹사이트](https://owlnest.app) · [튜토리얼](https://www.owlnest.app/docs) · [변경 내역][github-release-link] · [블로그](https://www.owlnest.app/blog)
...
<div align="center">
  <img src="../assets/node-translation-demo.gif" width="38%" alt="OwlNest 팝업 인터페이스" />
  <img src="../assets/page-translation-demo.gif" width="60%" alt="OwlNest 번역 인터페이스" />
</div>

## 👋🏻 시작하기 및 커뮤니티 참여

OwlNest의 목표는 모든 수준의 언어 학습자에게 쉽고 지능적이며 개인화된 학습 경험을 제공하는 것입니다. AI 시대에는 이것이 가능해졌지만, 아직 시장에는 이 요구를 제대로 만족시키는 제품이 많지 않습니다. 그래서 우리는 직접 만들기로 했습니다.

사용자이든 개발자이든 OwlNest는 이 비전을 향한 여정에서 중요한 도구가 될 것입니다. OwlNest는 현재 활발히 개발 중이며, 문제가 있다면 언제든지 [이슈][issues-link]로 알려주세요.
...
OwlNest의 강력한 기능으로 일상적인 웹 읽기를 몰입형 언어 학습 경험으로 바꿀 수 있습니다.
...
AI가 읽고 있는 내용의 전체 문맥을 이해하도록 합니다. 활성화하면 OwlNest가 페이지 제목과 간결한 Markdown 형태의 페이지 내용을 추출하여 AI에 전달하고, 더 정확하고 문맥에 맞는 번역을 제공합니다.
...
지능형 요청 배치로 API 비용을 최대 70% 절감할 수 있습니다. OwlNest는 여러 번역 요청을 하나의 API 호출로 묶어 번역 품질을 유지하면서 오버헤드와 token 사용량을 줄입니다.
...
1. OwlNest를 친구와 가족에게 소개하세요.
2. [이슈][issues-link]와 피드백을 보내 주세요.
3. 코드를 기여하세요.

### 코드 기여

프로젝트 구조: [DeepWiki](https://deepwiki.com/DeepOrcaLab/OwlNest)

AI로 프로젝트 이해하기: [Dosu](https://app.dosu.dev/29569286-71ba-47dd-b038-c7ab1b9d0df7/documents)

자세한 내용은 [Contribution Guide](https://owlnest.app/en/docs/code-contribution/contribution-guide)를 확인하세요.
...
<img src="../assets/tabbit.avif" alt="Tabbit" height="20" /> **Meituan Tabbit Browser Team**: 비공개 소스 상업적 사용을 위한 무료 라이선스입니다. 범위는 v1.21.3 및 이전 버전(commit [`724863f`](https://github.com/DeepOrcaLab/OwlNest/commit/724863fdbc2d777766cada6c111235534ee03ca0))으로 제한됩니다. 2026년 3월 3일 오전 9시(밴쿠버 시간, UTC-8)에 부여되었습니다.
