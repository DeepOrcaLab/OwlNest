...
[Trang chính thức](https://owlnest.app) · [Hướng dẫn](https://www.owlnest.app/docs) · [Nhật ký phát hành][github-release-link] · [Blog](https://www.owlnest.app/blog)
...
<div align="center">
  <img src="../assets/node-translation-demo.gif" width="38%" alt="Giao diện popup của OwlNest" />
  <img src="../assets/page-translation-demo.gif" width="60%" alt="Giao diện dịch của OwlNest" />
</div>

## 👋🏻 Bắt đầu và tham gia cộng đồng

Tầm nhìn của OwlNest là mang đến trải nghiệm học ngôn ngữ dễ dùng, thông minh và cá nhân hóa cho người học ở mọi trình độ. Trong thời đại AI, điều này đã trở nên khả thi, nhưng vẫn chưa có nhiều sản phẩm đáp ứng tốt nhu cầu đó. Vì vậy chúng tôi quyết định tự xây dựng.

Dù bạn là người dùng hay nhà phát triển, OwlNest có thể là một phần quan trọng trong hành trình này. Dự án đang được phát triển tích cực, và mọi phản hồi hoặc [vấn đề][issues-link] đều được hoan nghênh.
...
Biến việc đọc web hằng ngày thành trải nghiệm học ngôn ngữ nhập vai với các tính năng của OwlNest.
...
Cho phép AI hiểu đầy đủ ngữ cảnh của nội dung bạn đang đọc. OwlNest trích xuất tiêu đề trang và phiên bản Markdown ngắn gọn của nội dung để AI tạo bản dịch chính xác và phù hợp ngữ cảnh hơn.
...
Tiết kiệm tới 70% chi phí API bằng cách gom yêu cầu thông minh. OwlNest nhóm nhiều yêu cầu dịch thành một lệnh gọi API duy nhất, giảm overhead và lượng token sử dụng mà vẫn giữ chất lượng dịch.
...
1. Giới thiệu OwlNest cho bạn bè và gia đình.
2. Báo cáo [issue][issues-link] và gửi phản hồi.
3. Đóng góp mã nguồn.

### Đóng góp mã nguồn

Cấu trúc dự án: [DeepWiki](https://deepwiki.com/DeepOrcaLab/OwlNest)

Yêu cầu AI hiểu dự án: [Dosu](https://app.dosu.dev/29569286-71ba-47dd-b038-c7ab1b9d0df7/documents)

Xem [Contribution Guide](https://owlnest.app/en/docs/code-contribution/contribution-guide) để biết thêm chi tiết.
